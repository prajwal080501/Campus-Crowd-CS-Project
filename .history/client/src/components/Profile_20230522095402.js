    ...
    <Card>
      {user ? (
        <Stack alignItems="center" spacing={2}>
          ...
          <Typography width="100%" textAlign="center" fontWeight={800} mt={3s} variant="h5">{user.username}</Typography>
          <Typography fontSize={18} variant="p">{user.degree}</Typography>
          <Typography width="100%" fontSize={16} textAlign="center" variant="p">{user.college}</Typography>
          </Box>
