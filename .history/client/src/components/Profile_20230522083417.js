    ...
    <Card>
      {user ? (
        <Stack alignItems="center" spacing={2}>
          ...
          <Box my={1} display="flex" flexDirection="column" justifyItems="center">
          <Typography variant="h5">{user.username}</Typography>
          <Typography variant="p">{user.degree}</Typography>
          <Typography variant="p">{user.college}</Typography>s
          </Box>
