    ...
    <Card>
      {user ? (
        <Stack alignItems="center" spacing={2}>
          ...
          <Typography fontSize={18} variant="p">{user.degree}</Typography>
          <Typography width="100%" backgroundColor="lightblue" padding="5px" borderRadius="5px" fontSize={16} textAlign="center" variant="p">{user.college}</Typography>
          </Box>
