      ...
      {user ? (
        <Stack alignItems="center" spacing={2}>
          ...
          <Box my={1} display="flex" flexDirection="column" justifyItems="center" width="100%">
            ...
            <Typography flex={1} backgroundColor="lightblue" padding="5px" borderRadius="5px" fontSize={16} textAlign="center" marginTop="10px" variant="p">{user.college}</Typography>
          </Box>
